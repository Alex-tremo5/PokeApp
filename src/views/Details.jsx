...
const Details = () => {
  ...
  <div className="row g-0 info">
    <div className="col-md-4 ">
      <img src={pokemonss.imageURL} className="img-fluid rounded-start img" alt="..."/>
    </div>
    <div className="col-md-8">
      ...
      <h2 >{pokemonss.name}</h2>
        ...
        <ul>
            ...
            <li>
            <p className="card-text">Special Attack: {pokemonss.spAttack}</p>
            </li>

            <li>
            <p className="card-text">Special Defense: {pokemonss.spDefense}</p>
            </li>
...
<button className="volver" onClick={() => navigate(`/characters`)}> Go back</button>
</>
  )
}
